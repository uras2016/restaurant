...
<div style="width: 35%; margin-left: 30px">
    ...
    <h1>Ингредиенты на складе</h1>



    <table class="sort" align="center" border="0.2" style="align-items: center" class="table table-striped">
        ...
        <c:forEach var="warehouse" items="${warehouses}">
            <tr>
                ...
                <td style="align-items: center; width: 20px">
                    <spring:url value="/admin/store/${warehouse.id}/delete" var="deleteUrl"/>
                    <a href="${deleteUrl}">Удалить</a>
                </td>
                <td style="align-items: center; width: 20px">
                    <spring:url value="/admin/store/${warehouse.id}/update" var="updateUrl"/>
                    <a href="${updateUrl}">Изменить остаток</a>
    ...
    <spring:url value="/admin/store/add" var="addUrl" />
